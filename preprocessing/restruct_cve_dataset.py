...
import sys
#被引用模块所在的路径
sys.path.append("/home/chengxiao/project/vul_detect")
...
if __name__ == '__main__':
    #前期需求
    root_dir = '/home/chengxiao/project/vul_label/commit_info'
    out_dir = '/home/chengxiao/project/vul_label'
    # classify_by_cweid(root_dir, out_dir)
    # json_dic = load_final_json(out_dir + 'final.json')
    # json_dic = load_final_json(out_dir + 'final.json')
    # dataset_dir = "../dataset"
    # repo_dir = 'D:/pycharmProject/dataset/repo'
    # parse_json(json_dic, dataset_dir, repo_dir)
    #暂时不用↑
    # classify_by_project(root_dir,out_dir)
    json_dic = load_final_json(out_dir + 'final.json')
    dataset_dir = "/home/chengxiao/dataset/vul/CVE"
    repo_dir = '/home/chengxiao/project/repo'
    parse_json(json_dic, dataset_dir, repo_dir)
